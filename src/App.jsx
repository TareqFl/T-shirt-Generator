...
const App = () => {
  return (
    <Box>
      ...
      <NavBar/>
      <Container>
<Stack display="flex" direction="row" sx={{marginTop:10,height:"800px"}}>
...
"img":{width:"200px",mixBlendMode:"multiply",display:"block"}
      }}>
...
"img":{width:"200px",mixBlendMode:"multiply",display:"block"}
       ...
       <img src={images[3]} alt={shirt}/>
       </Box>
 <img src={front} alt={shirt} width="100%" height="100%" style={{position:"relative",zIndex:1,display:"block"}}/>
